<?php
global $currencyText, $currencySymbol, $currencyIcon, $dollar;
...
// H;
    ...
    $tags_arr['accommodation_view']  = <<<H
     	<div class="container">
    		<div class="row">
    			<div class="col-xs-12 booking-acc-single">
	        		<a href="reservations" class="btn btn-brown" value="1" name="check-avail">$checkAvailabilityBtn</a>
	        	</div>
    		</div>
    	</div>
		  		...
		  		<div class="accom--wrapper">
		            <div class="row accom--content">
		                <div class="col-xs-12 col-sm-6 col-md-4 col-icon">
						 ...
						 <div class="price-quicklink" $hiddePrice>From $dollar {$from_price} <span class="currency_text">$currencyText</span></div>
		     			</div>
	            	</div>
