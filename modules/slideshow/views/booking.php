...
$ctaAvailabilityBtnText =BOOKING_AVAILABILITY_CTA_BTN;
...
<form action="/{$page_bookings->url}" method="post" class="form" role="form">
    ...
    <button type="submit" class="btn btn-brown" value="1" name="check-avail" id="check-avail">{$ctaAvailabilityBtnText}</button>
