...
$ctaBlogDetailsBtnText = BLOG_READ_MORE_BTN;
...
if( !empty($posts_arr) )
{
	foreach ($posts_arr as $post)
	{
		...
		if( !$is_single ){
			...
			$description .= '<br><a href="'.$pg_full_url.$post['full_url'].'" title="'.$post['title'].'" class="btn btn-brown read-more-link">'.$ctaBlogDetailsBtnText.'</a>';
