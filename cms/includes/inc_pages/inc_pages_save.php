...
function save_item (){
  ...
  //   }
	...
	if( file_exists($photo_full_path) && !is_dir($photo_full_path) )
    {
		...
		$resizer_class->resizer($upload_dir_full_path, $photo_full_path, THUMB_WIDTH, THUMB_HEIGHT, $thumb_name);
  ...
  if($ql_photo)
	{
		...
		if($ql_photo != $current_ql_photo)
		{
			...
			if( is_file($ql_photo_full) )
	        {
	            ...
	            $resizer_class->resizer($upload_dir_full_path, $ql_photo_full, THUMB_WIDTH, THUMB_HEIGHT, $thumb_name);
